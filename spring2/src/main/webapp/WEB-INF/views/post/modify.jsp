  ...
  <main>
    ...
    <div class="mt-2 card">
      ...
      <div class="card-body">
        <form id="modifyForm">
          <div class="mt-2">
            <label for="id" class="form-label">번호</label> <input id="id" name="id"
              class="form-control" type="text" value="${post.id}"
              readonly />
          </div>
          <div class="mt-2">
          ...
          <div class="mt-2">
            ...
            <textarea name="content" id="content" class="form-control" rows="5">${post.content}
							</textarea>
          </div>
          <div class="mt-2">
